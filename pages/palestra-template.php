<?php
/*
 * Template Name: palestra-template
 *
...
<div class="row padding-y">
	<div class="padding-y grid-9 row-container">
		<img src="<?php bloginfo('template_url'); ?>/design/layout/template/header-palestra-1.png" style="display: block; margin: auto; width: 100%;">
	</div>
</div>
